...
exports.patch = exports.default = void 0;
...
exports.patch = patch = snabbdom.init([_class.default, _eventlisteners.default, _props.default]);
...
function () {
  function Komponent(props) {
    ...
    this.setStyles = function (styleObject) {
      ...
      _utilities.fu.css.setup(_utilities.fu.preset());

      stylesheet = _utilities.fu.css.createStyleSheet(styleObject).attach();
      return stylesheet;
    };
  }
